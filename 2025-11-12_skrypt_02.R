...
# Wczytywanie z dysku
nowa_zelandia2 <- readr::read_csv("annual-enterprise-survey-2024-financial-year-provisional.csv")

# Ścieżka bezwzględna do tego samego pliku
"C:\Users\RaszJ\Documents\GitHub\Przetwarzanie_danych_JedrzejKisiel\annual-enterprise-survey-2024-financial-year-provisional.csv"
